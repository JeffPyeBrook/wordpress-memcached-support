...
if ( class_exists( 'Memcached' ) ) {
	require_once D:\web-site-dev\acme.org\wp-content\plugins\wordpress-memcached-support/memcached-class-object-cache.php';
	error_log( 'Memcached support using PHP Memcached class enabled' );
} else if ( class_exists( 'Memcache' ) ) {
	require_once D:\web-site-dev\acme.org\wp-content\plugins\wordpress-memcached-support/memcache-class-object-cache.php';
