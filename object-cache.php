...
if ( class_exists( 'Memcached' ) ) {
	require_once __DIR__ . '/plugins/memcached-object-cache/memcached-class-object-cache.php';
	error_log( 'Memcached support using PHP Memcached class enabled' );
} else if ( class_exists( 'Memcache' ) ) {
	require_once __DIR__ . '/plugins/memcached-object-cache/memcache-class-object-cache.php';
	if ( defined( 'WP_DEBUG' ) && WP_DEBUG ) {
		error_log( 'Memcached support using PHP Memcache class enabled' );
	}
} else {
	error_log( 'No Memcached support, neither the PHP Memcached nor the PHP Memcache class was founnd, see http://pecl.php.net/' );
}
